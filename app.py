...
def panel_intro(ticker, heading, description):
    """Render a concise ticker-contextual subtitle beneath a panel title."""
    return (
        f'<p style="font-size:0.78rem;color:#8B9CB6;margin:-4px 0 14px 0;'
        f'line-height:1.55;padding-bottom:10px;border-bottom:1px solid rgba(255,255,255,0.05);">'
